...
extension UIView {
  ...
  // 设置边框
  func extSetBorder(width: CGFloat = 1.0, color: UIColor = .lightGray) {
    layer.borderWidth = width
    layer.borderColor = color.cgColor
  }

  // 设置圆角
  func extSetCorner(radius: CGFloat = 4.0) {
  ...
  func extMaskRoundedLayer(radius: CGFloat = 4.0, corners: UIRectCorner = .allCorners) {
  ...
  func extAddRoundedLayer(radius: CGFloat = 4.0,
